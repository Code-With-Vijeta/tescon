      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 z-10 relative">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 md:p-12">
          ...
          <div className="flex items-center gap-4 mb-8">
            <a
              href="#"
              className="bg-[#3b5998] text-white p-3 rounded-full hover:bg-blue-700 transition-all shadow-lg hover:scale-105"
            >
              <FaFacebookF />
            </a>
            <a
              href="#"
              className="bg-[#1da1f2] text-white p-3 rounded-full hover:bg-sky-500 transition-all shadow-lg hover:scale-105"
            >
              <FaTwitter />
            </a>
            <a
              href="#"
              className="bg-[#0077b5] text-white p-3 rounded-full hover:bg-blue-900 transition-all shadow-lg hover:scale-105"
            >
              <FaLinkedinIn />
            </a>
            <a
              href="#"
              className="bg-[#34a853] text-white p-3 rounded-full hover:bg-green-600 transition-all shadow-lg hover:scale-105"
            >
              <FaGooglePlay />
            </a>
          </div>
